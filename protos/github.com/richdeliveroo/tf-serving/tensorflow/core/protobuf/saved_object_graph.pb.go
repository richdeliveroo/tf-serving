...
import (
	framework "github.com/richdeliveroo/tf-serving/tensorflow/core/framework"
...
func (x *SavedVariable) GetSynchronization() framework.VariableSynchronization {
	...
	return framework.VariableSynchronization(0)
}
...
func (x *SavedVariable) GetAggregation() framework.VariableAggregation {
	...
	return framework.VariableAggregation(0)
}
...
var file_tensorflow_core_protobuf_saved_object_graph_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x42, 0x41, 0x5a, 0x3c, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
	0x6d, 0x2f, 0x72, 0x69, 0x63, 0x68, 0x64, 0x65, 0x6c, 0x69, 0x76, 0x65, 0x72, 0x6f, 0x6f, 0x2f,
	...
	0x62, 0x75, 0x66, 0xf8, 0x01, 0x01, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_tensorflow_core_protobuf_saved_object_graph_proto_goTypes = []interface{}{
	...
	(*framework.VersionDef)(nil),           // 19: tensorflow.VersionDef
	(*StructuredValue)(nil),                // 20: tensorflow.StructuredValue
	(framework.DataType)(0),                // 21: tensorflow.DataType
	(*framework.TensorShapeProto)(nil),     // 22: tensorflow.TensorShapeProto
	(framework.VariableSynchronization)(0), // 23: tensorflow.VariableSynchronization
	(framework.VariableAggregation)(0),     // 24: tensorflow.VariableAggregation
}
