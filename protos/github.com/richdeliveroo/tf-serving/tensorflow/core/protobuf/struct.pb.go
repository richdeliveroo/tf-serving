...
func (x *BoundedTensorSpecProto) GetShape() *framework.TensorShapeProto {
	if x != nil {
		return x.Shape
	}
	return nil
...
func (x *BoundedTensorSpecProto) GetDtype() framework.DataType {
	if x != nil {
		return x.Dtype
	}
	return framework.DataType(0)
...
var file_tensorflow_core_protobuf_struct_proto_rawDesc = []byte{
	...
	0x10, 0x0b, 0x42, 0x3e, 0x5a, 0x3c, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d,
	0x2f, 0x72, 0x69, 0x63, 0x68, 0x64, 0x65, 0x6c, 0x69, 0x76, 0x65, 0x72, 0x6f, 0x6f, 0x2f, 0x74,
...
var file_tensorflow_core_protobuf_struct_proto_goTypes = []interface{}{
	...
	(*framework.TensorShapeProto)(nil), // 12: tensorflow.TensorShapeProto
	(framework.DataType)(0),            // 13: tensorflow.DataType
	(*framework.TensorProto)(nil),      // 14: tensorflow.TensorProto
}
